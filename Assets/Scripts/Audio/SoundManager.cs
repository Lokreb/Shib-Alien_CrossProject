...
* 4) Attach an AudioSource component for each childrens (Music Source / effects source)
...
public class SoundManager : MonoBehaviour
{
    ...
    /// <summary>Plays the sfx once  when used</summary>
    ...
    /// <summary>Change the volume of all AudioListener in the scene</summary>
    /// <param name="value">sfx volume between 0.0 and 1.0</param>
